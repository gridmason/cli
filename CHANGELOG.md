...
- 1a774e0: `publish` now signs and uploads the `@gridmason/protocol` **`SignatureEnvelope`**
...
- ba9187e: publish: poll review status at `GET /v1/artifacts/:id/status` (registry path collision fix, #67)
